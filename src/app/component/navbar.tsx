    ...
    >
      <div className="max-w-screen-xl mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <Link href="/" className="flex items-center space-x-3">
          <Image src="/img/PingPong.png" className="h-14" alt="PingPong Logo" width={56} height={56} />
        ...
        >
          <ul className="flex flex-col md:flex-row md:space-x-6 px-4 py-2 md:p-0">
            {menuItems.map((item) => (
              <li key={item.name}>
                <Link href={item.href} className={`block py-2 px-3 rounded-md text-lg transition-all duration-200 ${
                  item.current
